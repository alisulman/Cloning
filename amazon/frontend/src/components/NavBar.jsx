            ...
            <div className="container mx-auto flex flex-wrap items-center justify-between text-white py-2">
                ...
                <div className="hidden  items-center gap-x-3 lg:flex">
                    <div className="relative flex items-center md:w-max">
                        <Input type="search" containerProps={{ className: "min-w-[750px]", }} className="w-full h-8 p-3 mt-1" />
                        <div className='bg-orange-500 p-2'><FaSearch className='flex items-center mx-1' /></div>
                    </div>
